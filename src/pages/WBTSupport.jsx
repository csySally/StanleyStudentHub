          ...
          {activeCard === null && (
            <div className="work-card">
              <div className="wbt-card">
                ...
                <div>
                  <p>
                    Get hands-on experience through structured Work-Based
                    Training (WBT).
                  </p>
                  <p>
              ...
              <div className="he-card">
                ...
                <div>
                  <p>
                    Transition from study to work with fieldwork placement and
                    WIL (Work-Integrated Learning).
                  </p>
                  <p>
                    These placements are part of your academic program and may
                    be arranged by Stanley College or initiated by you. They
                    help you build real-world skills, connect with industry, and
          ...
          {activeCard === "vet" && (
            <div className="vet-card-content">
              ...
              <div className="what-is-wbt">
                <p>
                  Work-Based Training (WBT) or Clinical Work Placement (CWP) is
                  a<b> mandatory and assessable component</b> of many VET
                  courses at Stanley College. It allows you to gain practical
                  experience in real industry environments and counts as class
                  time.
                </p>
                <ul>
                  <li>
                    Organised by Stanley College’s Employment Liaison Team
                  </li>
                  <li>
                    You must complete the prescribed hours/service periods to
                    pass the unit
                  </li>
                  <li>
                    During WBT, students must complete at least 20 course
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th>Course</th>
                      <th>
                        Allocated Hours – Work-Based Training (WBT)/ Clinical
                        Work Placement
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        CHC30121 Certificate III in Early Childhood Education
                        and Care
                      </td>
