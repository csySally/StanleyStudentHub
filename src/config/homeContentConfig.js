...
import homeCard1 from "../assets/icons/Service.svg";
import homeCard2 from "../assets/icons/consulting.svg";
import homeCard3 from "../assets/icons/Wedding Rings.svg";
...
export const homeCardData = [
  {
    ...
    description: "Our team is here to help you with any urgent matters",
    email: "studentservices@stanleycollege.edu.au",
    phone: "(08) 6731 9999",
  },
  {
    logo: homeCard2,
...
export const homeSlides = [
  {
    ...
    With over 90 guests in attendance, the event was a vibrant celebration of culture, community, and culinary skills!
`,
    image: home1,
  },
  {
    title: "Kings Park Picnic",
    description: `Last Thursday, Stanley College students had an enjoyable picnic at Kings Park, celebrating unity in diversity through fun-filled games, exciting performances, and just an overall joyful vibe! 🥳🤩

Thank you, StudyPerth, Western Australia for joining us!`,
    image: home2,
  },
  {
    title: "Career Expo",
    description: `A huge shoutout to all the awesome students who dropped by Stanley College’s Booth today- we loved meeting all of you!🙌

Haven’t visited our booth yet? Come check us out this weekend! Our friendly team is more than happy to help you explore study options. And don’t forget to grab some freebies when you visit us😉

Visit Stanley College at Booth #𝟰𝟬𝟭 and #𝟱𝟬𝟮!🤩`,
    image: home3,
  },
  {
    title: "A Well-deserved Break",
    description: `Our amazing Nursing students came together for a special lunch, marking the end of their first term. To our hardworking students, see you next term!🥳🥳`,
    image: home4,
  },
];

export const homeOuterLink = [
  {
    logo: outerLink1,
    title: "Canvas",
